...
I am interested in examining how the available Yelp business data may be analysed and processed with 
...
I have attempted to answer these questions and both my methodology and results are set out
below:

Methods and data
-------------------------

The available YELP dataset is the main data that is being used for this exercise. These are  
essentially data relating to reviews of various businesses, in a variety of locations, contained in 
...
compiled and used for other purposes. 
...
THe seasons were examined to atempt to ascertain whether, or not there are indeed seasonal 
variations in the scores being posted, using the dates of the reviews.
...
The sentiment analysis involves parsing the review text and attempting to discern the sentiment using 
a lexicon matching method, why remaining cogniscant to the syntax. Thus the sententce: "The restaurand 
had a beautiful view and gorgeous furniture, but the food and service was awful", contains sentiment that
is both negative and positive and both sentiments need to be considered and compared with the 
corresponding star score given.   
...
To begin with, there are slight seasonal variations, with the most review being submitted in Summer. This 
is significantly more than the other three seasons. Winter show a slight reduction.

##### Percentage reviews by season table
...
##### Percentage reviews by season and gender table
...
Looking at sentiment, this correlated well in many cases to the stars. People who have a negative experience 
...
##### Percentage reviews for negative sentiment by star
...
##### Percentage reviews for positive sentiment by star
...
previous reviews and this raises the question, "Do these reviews affect your score / post?". In this world of
social media, there appears to be a desire to gravitate collectively to positive social influence i.e. 
a social influence bias.
